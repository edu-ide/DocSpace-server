...
{    
    ...
    public Task<Dictionary<Guid, UserRelation>> GetUserRelationsByTargetAsync(Guid targetUserId)
    {
        return userService.GetUserRelationsAsync(Tenant.Id, targetUserId);
    }
